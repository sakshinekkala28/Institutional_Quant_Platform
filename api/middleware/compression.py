...
def compressible(
    ...
    return any(
        ...
        for item in COMPRESSIBLE_CONTENT_TYPES
    )
...
def estimated_savings(
    ...
    compressed = int(original_size * ratio)

    saved = original_size - compressed
