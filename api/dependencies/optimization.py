...
@lru_cache
def get_mean_variance_optimizer() -> MeanVarianceOptimizer:
    """
    Mean-Variance optimizer.
    """
...
@lru_cache
def get_black_litterman_engine() -> BlackLittermanEngine:
    """
...
@lru_cache
def get_efficient_frontier_engine() -> EfficientFrontierEngine:
    """
    Efficient frontier engine.
    """
...
@lru_cache
def get_expected_return_engine() -> ExpectedReturnEngine:
    """
    Expected return engine.
    """
