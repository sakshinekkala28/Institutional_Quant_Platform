...
def annualize_return(
    ...
    periods_per_year: int = (RiskConstants.TRADING_DAYS_PER_YEAR),
) -> float:
    """
    Annualize arithmetic return.
    """

    return periodic_return * periods_per_year
...
def annualize_volatility(
    volatility: float, periods_per_year: int = (RiskConstants.TRADING_DAYS_PER_YEAR)
) -> float:
    """
...
def annualize_variance(
    variance: float, periods_per_year: int = (RiskConstants.TRADING_DAYS_PER_YEAR)
) -> float:
    """
    Annualize variance.
    """

    return variance * periods_per_year
...
def annualize_tracking_error(
    tracking_error: float, periods_per_year: int = (RiskConstants.TRADING_DAYS_PER_YEAR)
) -> float:
    """
    Annualize tracking error.
    """

    return annualize_volatility(tracking_error, periods_per_year)
...
def annualize_sharpe_ratio(
    sharpe_ratio: float, periods_per_year: int = (RiskConstants.TRADING_DAYS_PER_YEAR)
) -> float:
    """
...
def annualize_information_ratio(
    ...
    return information_ratio * np.sqrt(periods_per_year)
...
def scale_by_periods(value: float, periods_per_year: int) -> float:
    """
