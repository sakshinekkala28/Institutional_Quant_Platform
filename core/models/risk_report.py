...
class RiskReport:
    ...
    def factor_count(self) -> int:
        ...
        return len(self.factor_exposures)
    ...
    def factor(self, name: str) -> float:
        ...
        return self.factor_exposures.get(name, 0.0)

    # =====================================================
    # MODIFICATION
    # =====================================================

    def add_factor(self, name: str, exposure: float) -> None:
        """
        Add or replace factor exposure.
        """

        self.factor_exposures[name] = exposure
    ...
    def validate(self) -> None:
        ...
        for value in numeric_fields:
            if not isinstance(value, (int, float)):
                raise TypeError("Risk metrics must be numeric.")
