...
class RiskParityOptimizer(BaseOptimizer):
    ...
    def risk_contribution(
        ...
        sigma = self.portfolio_volatility(weights)
    ...
    def objective(
        ...
        contribution = self.risk_contribution(weights)

        target = np.mean(contribution)
    ...
    def __repr__(self) -> str:
        ...
        return f"{self.__class__.__name__}(LongOnly={self.long_only})"
