...
class ReportBuilder:
    ...
    def add_backtest(
        ...
        self.sections["Backtest"] = report.summary()
    ...
    def add_risk(
        ...
        self.sections["Risk"] = report.summary()
    ...
    def add_optimization(
        ...
        self.sections["Optimization"] = report.summary()
    ...
    def add_execution(
        ...
        self.sections["Execution"] = report.summary()
    ...
    def __repr__(
        ...
        return f"{self.__class__.__name__}(Sections={self.number_of_sections})"
