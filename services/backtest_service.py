    ...
    def execute(
        ...
        **kwargs
        ...
        if engine not in self._engines:
            ...
            raise BacktestEngineNotFound(

                engine

            )

        backtest_engine = self._engines[
