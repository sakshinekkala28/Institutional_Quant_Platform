...
class MetricsRegistry:
    ...
    def exists(
        ...
        return metric_name in self._registry
    ...
    def by_category(
        ...
        return [
            metric for metric in self._registry.values() if metric.category == category
        ]
    ...
    def categories(
        ...
        return sorted({metric.category for metric in self._registry.values()})
    ...
    def __repr__(
        ...
        return f"{self.__class__.__name__}(Metrics={self.count})"
