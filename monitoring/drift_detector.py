...
class DriftDetector:
    ...
    def mean_shift(
        ...
        return float(abs(np.mean(current) - np.mean(reference)))
    ...
    def variance_shift(
        ...
        return float(abs(np.var(current) - np.var(reference)))
    ...
    def report(
        ...
        return {
            "FeatureDrift": feature.summary(),
            "DistributionDrift": distribution.summary(),
        }
