...
class PortfolioMonitor:
    ...
    def cash_utilization(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if utilization <= 95 else "WARNING"),
            value=round(
                utilization,
                2,
            ),
    ...
    def concentration(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if hhi < 0.15 else "WARNING"),
            value=round(
                float(hhi),
                4,
            ),
    ...
    def position_limit(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if maximum_weight <= maximum else "CRITICAL"),
            value=round(
                maximum_weight,
                4,
            ),
    ...
    def leverage(
        ...
        return PortfolioMonitorResult(
            metric="Leverage",
            status=("OK" if leverage <= 1.0 else "WARNING"),
            value=round(
                leverage,
                4,
            ),
    ...
    def sector_exposure(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if maximum <= limit else "WARNING"),
            value=round(
                maximum,
                4,
            ),
    ...
    def turnover(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if turnover <= limit else "WARNING"),
            value=round(
                turnover,
                4,
            ),
    ...
    def constraint_violations(
        ...
        return PortfolioMonitorResult(
            ...
            status=("OK" if violations == 0 else "CRITICAL"),
            value=violations,
            threshold=0,
            timestamp=datetime.utcnow(),
            metadata={},
